...
//    	   Friend friend1 = new Friend(in.nextInt(), chocolatesPurchased);
    ...
    public static void recursiveCalculation(int numOfChocolates, int chocolatePerWrappers, boolean continues)
    {
    	if(numOfChocolates == 1)
    	{
    		continues = false;
    	}
    	else
    	{
        		chocolatesPurchased += numOfChocolates/chocolatePerWrappers;
        		numOfChocolates = numOfChocolates/chocolatePerWrappers;
        		recursiveCalculation(numOfChocolates, chocolatePerWrappers, true);
    	}
